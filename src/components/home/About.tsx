  ...
  return (
    ...
    >
      ...
      <Container className="relative">
        ...
        >
          <p>
            Great software speaks for itself. We build things that are thoughtful,
            capable, and easy to use — from AI tools to websites, analytics, and
            business platforms, each one shaped by the same standard of craft.
          </p>

          <p>
            We treat every product the same way — with care, from start to finish.
            Software, insight, and product, each one built with the same attention,
            and aimed at the same result: something that drives progress.
          </p>
        </motion.div>
        </div>
      </Container>
